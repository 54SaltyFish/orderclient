...
public class DateChooserPanel extends JPanel {
    ...
    private static final String[] showTEXT = {"周日","周一","周二","周三","周四","周五","周六"};
    ...
    private DateChooserPanel(java.util.Date date, String format, int startDAY){
    ...
    public static DateChooserPanel getInstance(java.util.Date date, String format){
        return new DateChooserPanel(date, format, defaultStartDAY);
    }

    public static DateChooserPanel getInstance(java.util.Date date){
        return getInstance(date, DEFAULTFORMAT);
    }
    public static DateChooserPanel getInstance(String format){
        return getInstance(new java.util.Date(), format);
    }
    public static DateChooserPanel getInstance(){
        return getInstance(new java.util.Date(), DEFAULTFORMAT);
    }

    private void initCalendarPanel(){
        calendarPanel = new JPanel(new java.awt.BorderLayout());
        calendarPanel.setBorder(javax.swing.BorderFactory.createLineBorder(
                new java.awt.Color(0xAA, 0xAA, 0xAA)));
    ...
    private class BodyPanel extends JPanel {
        ...
        public void updateDate() {
            ...
            // 从当月1号前移，一直移动到面板显示的第一天的前一天；当-index + defaultStartDAY为正数时，
            // 为避免面板从当月1号之后开始显示，需要前移一周，确保当月显示完全
    ...
    private class DayLabel extends JLabel implements java.util.Comparator<DayLabel>,
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<DateChooserPanel.DayLabel>();
        }
    ...
    public static void main(String[] args) {
        ...
        DateChooserPanel ser = DateChooserPanel.getInstance();
        javax.swing.JTextField text = new JTextField();
        text.setBounds(10, 10, 200, 30);
        text.setText("2013-10-11");
        ser.register(text);

        DateChooserPanel ser2 = DateChooserPanel.getInstance("yyyy年MM月dd日");
